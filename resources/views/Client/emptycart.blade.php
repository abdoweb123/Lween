...
<body>
  ...
  <div class="container section-top d-flex flex-column justify-content-center my-5" style="min-height: 60vh;">
    <div class="row justify-content-center">
      ...
      <div class="col-12 text-center">
        ...
        <button class="bg-black fw-light text-white border-0 w-auto px-5 py-2 my-4"
