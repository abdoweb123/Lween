...
<div class="row">
    <div class="my-2 col-6 text-sm-start">
        <a href="{{ route('admin.processors.create') }}" class="main-btn">@lang('trans.add_new')</a>
    </div>
...
<table class="table table-bordered data-table" >
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.processors.show', $Model) }}"><i class="fa-solid fa-eye"></i></a>
                <a href="{{ route('admin.processors.edit', $Model) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                <form class="formDelete" method="POST" action="{{ route('admin.processors.destroy', $Model) }}">
                    @csrf
